...
public class RestaurantException {
    ...
    inmediatament executa una excepció general (new Exception) per avisar que el producte no existeix, per tant
    no s'ha d'afegir a la llista, però el bucle ha de seguir executant-se. Llança una excepció general (new Exception)
    a la pregunta Si/No per seguir demanant, en cas de que l'usuari no introdueixi cap de les paraules clau.
    ...
    */
    ...
    protected static void comandaUsuaris(Scanner sc) throws Exception {
        ...
        for (int i = 0; i < numplats; i++) {
            ...
            try{
                ...
                if(menuPreus.containsKey(nomMenu)) comanda.add(nomMenu);
                    ...
                    throw new Exception("Aquesta pizza que has indicat, no es troba a la carta.\n" +
